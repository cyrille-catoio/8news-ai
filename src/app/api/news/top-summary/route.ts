...
function generateHomepageSummaryPrompt(lang: Lang): string {
  if (lang === "fr") {
    return [
      ...
      "4. Produis entre 8 et 15 bullet points selon la richesse de l'actualité.",
      "5. Chaque bullet point DOIT référencer dans \"refs\" les indices de TOUS les articles qui alimentent ce point. C'est essentiel pour que le lecteur puisse accéder aux sources.",
      "6. Si un article ne rentre dans aucun groupe cohérent, ignore-le plutôt que de forcer un regroupement artificiel.",
      "7. Sois factuel, précis et informatif. Le ton doit être celui d'un analyste tech professionnel.",
      "",
  ...
  return [
    ...
    "4. Produce 8-15 bullet points depending on how rich the news cycle is.",
    "5. Each bullet point MUST reference in \"refs\" the indices of ALL articles that feed into that point. This is essential so readers can access the sources.",
    "6. If an article does not fit any coherent group, skip it rather than forcing an artificial grouping.",
    "7. Be factual, precise, and informative. The tone should be that of a professional tech analyst.",
    "",
