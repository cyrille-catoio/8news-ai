...
// Query params materially change this payload (`lang`, `since`, `limit`, and
// personalized `topics`). Netlify has previously reused path-level CDN entries
// for query-driven API routes when `s-maxage` was set, so keep this endpoint
// fully dynamic and no-store.
