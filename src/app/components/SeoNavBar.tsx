    ...
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && !authLoading && (
        <div style={{
          ...
          {isOwner && authed && (
            <>
              <a href="/topics" onClick={() => setOpen(false)} style={menuItemStyle}>{t("navTopicsAria", lang)}</a>
    ...
    <header style={{ paddingBottom: 12, marginBottom: 20, position: "relative" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <NavLink href="/" ariaLabel={t("navHomeAria", lang)}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M3 9.5L12 3l9 6.5V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9.5z" />
              <polyline points="9 21 9 14 15 14 15 21" />
            </svg>
          </NavLink>
          <NavLink href="/stats" ariaLabel={t("navStatsAria", lang)}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <NavLink href="/crons" ariaLabel={t("cronMonitor", lang)}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
            </svg>
          </NavLink>
          <NavLink href="/changelog" ariaLabel={t("changelog", lang)}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 8v4l3 3" />
              <circle cx="12" cy="12" r="10" />
            </svg>
          </NavLink>
          <NavLink href="/settings" ariaLabel={t("settings", lang)}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
