 ...
 * the shared cap. Longer briefings need future chunking/async generation;
 * sending them as one synchronous request can time out and leave the
 * player with no audio.
 */
