...
function FeedsAdminPage({ lang, topics }: { lang: Lang; topics: TopicLabel[] }) {
...
export default function Home() {
  ...
  const [error, setError] = useState<string | null>(null);
  const [currentPage, setCurrentPage] = useState<"home" | "stats" | "crons" | "topics" | "settings" | "changelog" | "feeds">("home");
        ...
        <header style={{ paddingBottom: 12, marginBottom: 20, position: "relative" }}>
          <div style={{ position: "absolute", top: 0, right: 0, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6 }}>
            ...
            <button
              ...
              aria-label={t("feedsAdminAria", lang)}
              style={{
                padding: 4,
                border: "none",
                background: "transparent",
                color: currentPage === "feeds" ? color.gold : color.textMuted,
                cursor: currentPage === "feeds" ? "default" : "pointer",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              }}
