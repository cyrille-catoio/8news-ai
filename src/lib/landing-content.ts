...
export const LANDING_CONTENT: LandingContent = {
  ...
  pricing: {
    ...
    plans: {
      en: [
        { tag: "CURRENT", name: "Free", price: "$0", per: "/forever", desc: "Everything we shipped in v2.5.4. No credit card, no waitlist.", features: ["Choose 8 topics out of 36 available, powered by 400+ RSS feeds", "Top 50 daily with AI summary + sources, favorites and daily summaries archive", "YouTube transcription (5 per day)", "Bilingual EN / FR"], cta: "Try it now", featured: false },
      ...
      fr: [
        { tag: "ACTUEL", name: "Gratuit", price: "0 €", per: "/à vie", desc: "Tout ce qu'on a livré en v2.5.4. Sans carte bancaire, sans liste d'attente.", features: ["Choisissez 8 topics parmi les 36 disponibles, alimentés par 400+ flux RSS", "Top 50 quotidien avec résumé IA + sources, favoris et archive des résumés quotidiens", "Transcription YouTube (5 par jour)", "Bilingue EN / FR"], cta: "Essayer", featured: false },
