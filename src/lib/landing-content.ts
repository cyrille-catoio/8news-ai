...
export const LANDING_CONTENT: LandingContent = {
  ...
  pricing: {
    ...
    plans: {
      ...
      fr: [
        { tag: "ACTUEL", name: "Gratuit", price: "0 €", per: "/à vie", desc: "Tout ce qu'on a livré en v2.4. Sans carte bancaire, sans liste d'attente.", features: ["Les 36 topics par défaut avec 400+ flux RSS", "Top 50 quotidien avec résumé IA + sources", "Transcription YouTube (5 par jour)", "Text-to-speech ElevenLabs (12 voix)", "Favoris, archive des résumés quotidiens", "Bilingue EN / FR"], cta: "Essayer", featured: false },
