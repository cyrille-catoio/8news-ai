...
export const LANDING_CONTENT: LandingContent = {
  ...
  pricing: {
    ...
    plans: {
      en: [
        { tag: "CURRENT", name: "Free", price: "$0", per: "/forever", desc: "Everything we shipped in v2.6.8. No credit card, no waitlist.", features: ["Choose 8 topics out of the 36 available.", "Top daily articles and videos with AI summary + sources.", "YouTube transcription and video summaries.", "Morning email digest covering your topics.", "Bilingual EN / FR"], cta: "Try it now", featured: false },
      ...
      fr: [
        { tag: "ACTUEL", name: "Gratuit", price: "0 €", per: "/à vie", desc: "Tout ce qu'on a livré en v2.6.8. Sans carte bancaire, sans liste d'attente.", features: ["Choisissez 8 topics parmi les 36 disponibles.", "Top des articles et videos quotidiens avec résumé IA + sources.", "Transcription YouTube et résumé des vidéos.", "Newsletter matinale reprenant vos topics.", "Bilingue EN / FR"], cta: "Essayer", featured: false },
